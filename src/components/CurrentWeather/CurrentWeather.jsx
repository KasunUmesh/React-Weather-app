        ...
        <div className="flex flex-wrap">
            ...
            <div className="flex flex-col m-8 ml-8">
                ...
                <div className="flex items-center justify-start mb-[0.8rem]">
                    ...
                    <span className="text-[#3080c8] font-medium text-[1.25rem]">{data === null ? <p>10</p> : Math.round(data.main.humidity)}%</span>
                </div>
                <div className="flex items-center justify-start mb-[0.8rem]">
                    <div className="flex text-[#7B98B2] items-center text-[1.25rem] w-32">
                       <WiCloudyWindy className="mr-4 w-[1.6rem] ml-[-0.3rem]" /> Wind
                    </div>
                    <span className="text-[#3080c8] font-medium text-[1.25rem]">{data === null ? <p>10</p> : Math.round(data.wind.speed)}kph</span>
                </div>
                <div className="flex items-center justify-start mb-[0.8rem]">
                    <div className="flex text-[#7B98B2] items-center text-[1.25rem] w-32">
                       <TiWeatherSnow className="mr-4 w-[1.6rem] ml-[-0.3rem]" /> Pressure
                    </div>
                    <span className="text-[#3080c8] font-medium text-[1.25rem]">{data === null ? <p>10</p> : Math.round(data.main.pressure)}hpa</span>
                </div>
            </div>
        </div>
    </div>
